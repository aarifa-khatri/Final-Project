...
# source1 = ColumnDataSource(data=dict(Professor = prof[], A = A[], B = B[], 
#                         C = C[], Other = other[]))
...
# select2= Select(title= 'Choose Class', value= '', options= courses )
